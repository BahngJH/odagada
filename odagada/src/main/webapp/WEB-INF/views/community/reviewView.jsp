...
<style>
	...
	<div id="review-container">
		...
		<h3>평점</h3>
		<p id="rating">
			<img id="star" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTNyFbLPFRhaBPCULjo9UH-IFjQ7xdM9STpYR65IcC60uGd0ddHw">
			<span>4/5 - 1개의 평점</span>
		</p>
		<li id="review-context">
			<a href="${path }}/">
				<div class="review-content" id="writerNum" name="writerNum">멤버 아이디</div>
			</a>
			...
			<p id="review-content">
				<span id="review-content" value="${rContent }">제가 3월 7일에도 할리스를 갔는데요... 여기 옆에 중국인이 계시네요. 니 취팔러마 한마디 해줄까요?</span>
			</p>
			<div id="review-Date" id="rDate" name="rDate" value="${rDate}">19/03/07</div>
		</li>
		</ul>
		</div>
	</div>
