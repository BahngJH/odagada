...
<div id="review-container">
	...
	<h1>리뷰</h1>
	<br/>
	<input type="button" value="내가 작성한 리뷰" id='btn-reviewView' class='btn btn-outline-success' onclick='location.href="${path}/community/myReviewView.do"'/>
	<input type="button" value="리뷰보기" id='btn-myReviewView' class='btn btn-outline-success' onclick='location.href="${path}/community/reviewView.do"'/>
